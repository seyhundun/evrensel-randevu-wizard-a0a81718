...
const REPO_PULL_CMD = "cd ~/vfs-bot && git remote set-url origin https://github.com/seyhundun/evrensel-randevu-wizard-a0a81718.git && git fetch origin && git reset --hard origin/main && cd bot && npm install && pm2 restart all";
